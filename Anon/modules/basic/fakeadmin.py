...
from pyanon.helper.basic import edit_or_reply, get_text
from pyanon.helper.constants import MEMES
from Anon import cmds
from Anon.modules.basic.profile import extract_user, extract_user_and_reason
from Anon.modules.basic.help import *
from Anon.modules.basic.broadcast import get_arg
ok = []
xxxx = [
    "12",
    "34",
