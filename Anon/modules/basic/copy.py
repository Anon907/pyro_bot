...
@Client.on_message(filters.command("takepm", cmds) & filters.me)
...
@Client.on_message(filters.command("take", cmds) & filters.me)
...
@Client.on_message(filters.command("fwd", cmds) & filters.me)
async def fwd(client: Client, message: Message):
    ...
    try:
       ...
       await message.delete()
        ...
        pass
#command c for anu
@Client.on_message(filters.command("c", cmds) & filters.me)
...
@Client.on_message(filters.command("cp", cmds) & filters.me)
