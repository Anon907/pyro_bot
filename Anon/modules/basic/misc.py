# if you can read this, this meant you use code from Anon Ram Project
# this code is from somewhere else
# please dont hestitate to steal it
# because Anon and Ram doesn't care about credit
...
alive_logo = ALIVE_PIC or random.choice(anonlogo)
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"  • **Anon Library**: `{gver}`\n\n"
        f"©️2023 [Anon Support](t.me/de_xrobotsupport)\n"
    )

@Client.on_message(filters.command(["anon"], cmds) & filters.me)
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("repo Anon-Pyro Official: \n\n\nhttps://github.com/Anon907/pyro_bot")
